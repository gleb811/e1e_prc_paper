...
draw_1d_hist(1,m_pip_p_model,qqq.str(),"h1prj_inv_m_pip_p_1_model","d#sigma/dM (#mub/GeV)","M_{#pi^{+}p} (GeV)",1, 1,"B","mass",i);
qqq.str("");
...
draw_1d_hist(1,m_pip_p_noempty,qqq.str(),"h1prj_inv_m_pip_p_1_gen","d#sigma/dM (#mub/GeV)","M_{#pi^{+}p} (GeV)",1, 25,"e1AP same","mass",i);
qqq.str("");
...
draw_1d_hist(2,m_pip_pim_model,"","h1prj_inv_m_pip_pim_1_model","d#sigma/dM (#mub/GeV)","M_{#pi^{+}#pi^{-}} (GeV)",1, 1,"B","mass",i);
...
draw_1d_hist(2,m_pip_pim_noempty,"","h1prj_inv_m_pip_pim_1_gen","d#sigma/dM (#mub/GeV)","M_{#pi^{+}#pi^{-}} (GeV)",1, 25,"e1AP same","mass",i);
...
draw_1d_hist(3,m_pim_p_model,"","h3prj_inv_m_pim_p_1_model","d#sigma/dM (#mub/GeV)","M_{#pi^{-}p} (GeV)",1, 1, "B","mass",i);
...
draw_1d_hist(3,m_pim_p_noempty,"","h3prj_inv_m_pim_p_1_gen","d#sigma/dM (#mub/GeV)","M_{#pi^{-}p} (GeV)",1, 25, "e1AP same","mass",i);
...
draw_1d_hist(4,theta_p_model,"","h1prj_th_P_model","d#sigma/d(-cos#theta) (#mub/rad)","#theta_{p'} in c.m. (deg)",1, 1, "B","theta",i);
...
draw_1d_hist(4,theta_p_noempty,"","h1prj_th_P_gen","d#sigma/d(-cos#theta) (#mub/rad)","#theta_{p'} in c.m. (deg)",1, 25, "e1AP same","theta",i);
...
draw_1d_hist(5,theta_pim_model,"","h1prj_th_PIm_model","d#sigma/d(-cos#theta) (#mub/rad)","#theta_{#pi^{-}} in c.m. (deg)",1, 1, "B","theta",i);
...
draw_1d_hist(5,theta_pim_noempty,"","h1prj_th_PIm_gen","d#sigma/d(-cos#theta) (#mub/rad)","#theta_{#pi^{-}} in c.m. (deg)",1, 25, "e1AP same","theta",i);
...
draw_1d_hist(6,theta_pip_model,"","h1prj_th_PIp_model","d#sigma/d(-cos#theta) (#mub/rad)","#theta_{#pi^{+}} in c.m. (deg)",1, 1, "B","theta",i);
...
draw_1d_hist(6,theta_pip_noempty,"","h1prj_th_PIp_gen","d#sigma/d(-cos#theta) (#mub/rad)","#theta_{#pi^{+}} in c.m. (deg)",1, 25, "e1AP same","theta",i);
...
draw_1d_hist(7,alpha_p_model,"","h1prj_alpha_PIpPIm_pipf_model","d#sigma/d#alpha (#mub/rad)","#alpha_{p'} (deg)",1, 1,"B","alpha",i);
...
draw_1d_hist(7,alpha_p_noempty,"","h1prj_alpha_PIpPIm_pipf_gen","d#sigma/d#alpha (#mub/rad)","#alpha_{p'} (deg)",1, 25, "e1AP same","alpha",i);
...
draw_1d_hist(8,alpha_pim_model,"","h2prj_alpha_PPIp_piPIm_model","d#sigma/d#alpha (#mub/rad)","#alpha_{#pi^{-}} (deg)",1, 1,"B","alpha",i);
...
draw_1d_hist(8,alpha_pim_noempty,"","h2prj_alpha_PPIp_piPIm_gen","d#sigma/d#alpha (#mub/rad)","#alpha_{#pi^{-}} (deg)",1, 25, "e1AP same","alpha",i);
...
draw_1d_hist(9,alpha_pip_model,"","h3prj_alpha_PPIm_piPIp_model","d#sigma/d#alpha (#mub/rad)","#alpha_{#pi^{+}} (deg)",1, 1,"B","alpha",i);
...
draw_1d_hist(9,alpha_pip_noempty,"","h3prj_alpha_PPIm_piPIp_gen","d#sigma/d#alpha (#mub/rad)","#alpha_{#pi^{+}} (deg)",1, 25, "e1AP same","alpha",i);
