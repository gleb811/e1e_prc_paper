...
qqq.str("");
//qqq << "counter " << i << " (negative particles)";
...
hist1->SetMinimum((hist1->Integral())/50000.);
hist1->SetMaximum((hist1->Integral())/1000.);
...
c->SaveAs("b_vs_p_negative_time_corr.pdf");
