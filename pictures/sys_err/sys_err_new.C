...
if ((qq2>=8)&&(qq2!=9)){
qqq.str("");
qqq << "\\small \\mathrm{Q^{2} = " << Q2_bin << "\\,\\, GeV^{2}}";
gae->SetTitle(qqq.str().c_str());
} 
*/
gae->SetTitle("");
 ...
 if (qq2==8)gae->GetYaxis()->SetLabelSize(0.07);
...
gae->Draw("a2");
  ...
  TLatex *t = new TLatex();
   ...
   t->SetTextSize(15.);
   t->SetTextAlign(12);
   t->DrawLatex(1.34,37.,qqq.str().c_str());
...
//Double_t data_int_mod_res[17] ={1.53701, 2.19138, 3.03188, 4.56564, 5.41792, 
