#!/bin/tcsh -f
rm ad_hoc_second.pdf
rm ad_hoc_second.aux
...
pdflatex ad_hoc_second
pdflatex ad_hoc_second
acroread ad_hoc_second.pdf >& /dev/null
rm ad_hoc_second.log ad_hoc_second.aux ad_hoc_second.toc ad_hoc_second.out 
